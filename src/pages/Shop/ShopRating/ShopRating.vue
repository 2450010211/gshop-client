    ...
    <div class="ratings-content">
      ...
      <div class="ratingselect">
        <div class="rating-type">
          <span class="block positive" :class="{active: selectType === 2}" @click="selectType=2"> 全部
            <span class="count">{{ratings.length}}</span>
          </span>
          <span class="block positive" :class="{active: selectType === 0}" @click="selectType=0"> 满意
            <span class="count">{{positiveSize}}</span>
          </span>
          <span class="block negative" :class="{active: selectType === 1}" @click="selectType=1"> 不满意
            <span class="count">{{ratings.length - positiveSize}}</span>
          </span>
        </div>
        <div class="switch" :class="{on: checkMessage}" @click="toggleCheckMessage">
        ...
        <ul>
          <li class="rating-item" v-for="(rating,index) in filterRatings" :key="index">
            ...
            <div class="content">
              ...
              </div> <p class="text">{{rating.text}}</p>
              <div class="recommend">
