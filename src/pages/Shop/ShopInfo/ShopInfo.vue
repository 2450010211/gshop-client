<template>
    <div class="shop-info">
      ...
      <section class="section">
        ...
        <div class="activity">
          <div class="activity-item" v-for="(support,index) in info.supports" :key="index" :class="supportClass[support.type]">
...
<script>
  ...
  export default {
    data(){
      return{
        supportClass: ['activity-green','activity-red','activity-orange'],  //活动样式
      }
    },
    computed:{
      ...mapState(['info']),
    ...
    methods:{
      _initScroll(){
        this.$nextTick(() =>{
          ...
          this.$refs.picsUl.style.width = (126 * this.info.pics.length - 6) + 'px';
